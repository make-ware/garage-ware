...
import type { User, RegisterData } from '@garage-ware/shared';
import type { TypedPocketBase } from '@/lib/types';
import { parseAuthError, withRetry } from '@garage-ware/shared';
import { UserMutator } from '@garage-ware/shared/mutators';
...
export class AuthService {
   ...
   *
   * This is an unauthenticated flow. PocketBase always resolves successfully
   * (whether or not the address maps to a real account) to avoid leaking
  ...
  /**
   * Confirm a password reset using the token from the reset email and set a
   * new password. Unauthenticated flow.
   */
